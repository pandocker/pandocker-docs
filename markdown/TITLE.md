...
この本で対象にするPandocのバージョンは~~**2.7.3**~~**2.9.2**です。2.7.3で書こうと思っていたのですが、
冬コミの直前に2.8がリリースされたので、バージョンアップしました。その後、その後あれよあれよと新しいバージョン
がリリースされて現在は2.9.2です。まあ半年あればそれくらい進むよね！
...
- Pythonスクリプトというかパッケージの話題が出てきます。２系でも３系でも通じます
  （が、この本を読む頃には２系が完全にEOLなので気にする必要はありませんね）。
...
- 書いててまとまりがなくて困ってる
- Switchでゼルダをやってエンディングの8bitで懐か死した
- COD MWのFALは当たらない子だけど武器レベル55あたりで3点バーストのパークをつけるとだいぶ強くなるよ
  - Gazﾊﾟｲｾﾝの誕生秘話なのでぜひキャンペーンやりましょう
- ﾃﾞｽｽﾄやったらこの本落ちるんでまだやってないです
- ゴーストリコンが終わらない
